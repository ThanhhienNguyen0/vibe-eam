...
let AnalysisController = class AnalysisController {
    ...
    async impact(branchId, elementKey, direction = 'downstream', maxDepth = '5') {
...
__decorate([
    ...
    __param(1, (0, common_1.Query)('elementKey')),
    __param(2, (0, common_1.Query)('direction')),
    __param(3, (0, common_1.Query)('maxDepth')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String, String]),
    __metadata("design:returntype", Promise)
], AnalysisController.prototype, "impact", null);
